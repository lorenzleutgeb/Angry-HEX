...
public class DeclarativeAlphaTactic extends Tactic {
	private static final Predicate WORLD_PREDICATE = Predicate.getInstance("world", 1);


	public DeclarativeAlphaTactic(final ClientActionRobotJava ar, final TacticManager manager) {
		super(ar, manager);
	}
